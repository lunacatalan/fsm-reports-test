...
/**
 * benthicHabitat: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function benthicHabitat(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("benthicHabitat");
  const metrics = (
    await Promise.all(
...
export default new GeoprocessingHandler(benthicHabitat, {
  title: "benthicHabitat",
  description: "boundary overlap of benthic habitats",
  timeout: 60, // seconds
